...
use App\Http\Resources\V2\Client\ClientCollection;
...
use App\Http\Resources\V2\Client\ClientResource;
...
class ClientController extends Controller implements HasMiddleware
{
    ...
    /**
     * @OA\Get(
     *     path="/api/v2/admin/clients",
     *     operationId="getAllClientsV2",
     *     summary="Get all clients (V2)",
    ...
    /**
     * @OA\Get(
     *     path="/api/v2/admin/clients/{id}",
     *     operationId="showClientV2",
     *     summary="Get client details (V2)",
     ...
     *     summary="Update client information (V2)",
     ...
     * @OA\Delete(
     *     path="/api/v2/admin/clients/{id}",
     *     operationId="deleteClientV2",
     *     summary="Delete a client (V2)",
