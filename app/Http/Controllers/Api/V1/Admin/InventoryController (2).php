...
class InventoryController extends BaseApiController
{
    public function __construct()
    {
        ...
        $this->middleware('permission:view-inventory')->only(['index', 'show', 'lowStockAlerts', 'outOfStockItems', 'statistics', 'stockMovements', 'report']);
        $this->middleware('permission:update-inventory')->only('update');
        $this->middleware('permission:update-stock')->only('updateStock');
        $this->middleware('permission:bulk-update-stock')->only('bulkUpdateStock');
    }
