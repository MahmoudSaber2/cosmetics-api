    ...
    <style>
        ...
        @layer theme {
            ...
            :host {
                ...
                --color-emerald-50: oklch(.977 .014 308.299);
                --color-emerald-100: oklch(.946 .033 307.174);
                --color-emerald-200: oklch(.902 .063 306.703);
                --color-emerald-300: oklch(.827 .119 306.383);
                --color-emerald-400: oklch(.714 .203 305.504);
                --color-emerald-500: oklch(.627 .265 303.9);
                --color-emerald-600: oklch(.558 .288 302.321);
                --color-emerald-700: oklch(.496 .265 301.924);
                --color-emerald-800: oklch(.438 .218 303.724);
                --color-emerald-900: oklch(.381 .176 304.987);
                --color-emerald-950: oklch(.291 .149 302.717);
                ...
                --color-green-50: oklch(.971 .014 343.198);
                --color-green-100: oklch(.948 .028 342.258);
                --color-green-200: oklch(.899 .061 343.231);
                --color-green-300: oklch(.823 .12 346.018);
                --color-green-400: oklch(.718 .202 349.761);
                --color-green-500: oklch(.656 .241 354.308);
                --color-green-600: oklch(.592 .249 .584);
                --color-green-700: oklch(.525 .223 3.958);
                --color-green-800: oklch(.459 .187 3.815);
                --color-green-900: oklch(.408 .153 2.432);
                --color-green-950: oklch(.284 .109 3.907);
